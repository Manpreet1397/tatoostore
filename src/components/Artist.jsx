  ...
  return (
    ...
    <div className="mx-auto bg-black text-white flex flex-col justify-center gap-16 lg:gap-40 pt-40 pb-24 px-12 md:px-32 text-center md:text-left">
                ...
                <div className="text-left">
                    ...
                    <div className="flex justify-center">
                        <div className="flex justify-end">
                            <h1 className="text-5xl  font-bold text-center ">OUR ARTISTS</h1>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <DisplayCard image="EDWIN.png" title="EDWIN WOOD" details="TATOO MASTER "/>
                <DisplayCard image="THOMAS.png" title="THOMAS CRUZ" details="TATOO MASTER" />
                <DisplayCard image="ALBERTO.png" title="ALBERTO HOFFMAN" details="TATOO MASTER" />
            </div>
            <div>
